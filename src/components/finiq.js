  ...
  calcular = () => {
    ...
    if (this.state.sueldo > 0 && this.state.sueldo !== undefined) {
      ...
      console.log(antig)
        ...
        prima = (vacaciones * ((sueldoDiario / 4) / 365) * RestaFechas2).toFixed(2);
        corresp = (((sueldoDiario * 15) / 365) * RestaFechas2).toFixed(2);
        granTotal = (parseFloat(corresp) + parseFloat(prima)).toFixed(2);
        ...
        <>
          ...
          <div className="center">
            ...
            <div id="sidebar" className="archivosAdminCenter3">
              ...
              <br/> <br/>
              <output>Vacaciones proporcionales a los días transcurridos del año: ${this.state.corresp} </output>
              <br/> <br/>
              <output>Prima vacacional correspondiente a los días trabajados del año: ${this.state.prima} </output>
              <br/> <br/>
